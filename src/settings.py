...
HOMEPAGE_URL: str = (
    "https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/LPGHKK"
)
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 12799447
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/makerere-university-maize"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = {
    "Datasheet": "https://dataverse.harvard.edu/file.xhtml?fileId=6420456&version=2.1"
}
